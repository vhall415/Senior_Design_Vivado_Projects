...
HD_PWD='C:/Users/vhall/Desktop/clk_out_test/clk_out_test.runs/design_1_clk_disp_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clk_disp_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clk_disp_0_0.tcl
