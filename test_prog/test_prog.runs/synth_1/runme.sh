...
HD_PWD='C:/Users/vhall/Desktop/test_prog/test_prog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_configure.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_configure.tcl
