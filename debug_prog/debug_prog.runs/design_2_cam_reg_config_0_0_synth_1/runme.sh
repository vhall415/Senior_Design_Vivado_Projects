...
HD_PWD='C:/Users/vhall/Desktop/debug_prog/debug_prog.runs/design_2_cam_reg_config_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_cam_reg_config_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_cam_reg_config_0_0.tcl
